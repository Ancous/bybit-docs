...
- `InversePerpetual` Инверсивные деривативы USDT/USDC не имеюшие экспирации
- `LinearPerpetual` Стандартные деривативы USDT/USDC не имеюшие экспирации
- `InverseFutures` Инверсивные деривативы USDT/USDC со сроком экспирации
- `LinearFutures` Стандартные деривативы USDT/USDC со сроком экспирации
