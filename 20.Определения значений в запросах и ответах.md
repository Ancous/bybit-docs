...
- `spot` Спот
- `linear` вечные или с датой экспирации фьючерсные контракты (***расчет проходит в фиате USDT или USDC***)
- `inverse` вечные или с датой экспирации фьючерсные контракты (***расчет проходит в базовой валюте BTC или ETH и др.***)
- `option` Опционы
...
- `LinearPerpetual` Стандартные фьючерный контракт USDT/USDC не имеюший дату экспирации
- `InversePerpetual` Обратный фьючерный контракт USDT/USDC не имеюший дату экспирации
- `LinearFutures` Стандартные фьючерный контракт USDT/USDC с датой экспирации
- `InverseFutures` Обратный фьючерный контракт USDT/USDC с датой экспирации
