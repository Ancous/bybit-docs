...
- `X-BAPI-SIGN` - подпись, сгенерированая через **HMAC_SHA256** или **RSA_SHA256**

Также можно передать в запрос заголовоки:

- `X-BAPI-RECV-WINDOW` -  (единица измерения в миллисекундах, значение по умолчанию 5000) для указания
