...
|[positionIdx](<../19.Определения значений в запросах и ответах.md#positionIdx>)      |integer   |Индекс позиции.<br>Используется для идентификации позиций в разных режимах<br>- `0`: Односторонний режим<br>- `1`: Покупка в обоих режимах<br>- `2`: Продажа в обоих режимах<br>       |
