...
|limit                     |нет  |integer     |***Ограничение количества данных на странице.***<br><br>от `1` до `200`       |`20`   |
...
|riskLimitValue   |string      |Значение предела риска<br>Для режима портфельной маржи это поле возвращает 0, что означает, что правила ограничения риска недействительны.                                             |
...
|positionIMByMp   |string      |Начальная маржа рассчитывается по цене маркировки.<br>- Классический аккаунт и [UTA1.0](<../13.Различные режимы аккаунтов.md#единый-торговый-аккаунт-1.0>)(`inverse`): игнорировать это поле.<br>- Режим маржинального портфеля UTA, возвращает `""`                                               |
...
|positionMMByMp   |string      |Поддерживаемая маржа, рассчитанная по цене маркировки.<br>- Классический аккаунт и [UTA1.0](<../13.Различные режимы аккаунтов.md#единый-торговый-аккаунт-1.0>)(`inverse`): игнорировать это поле.<br>- Режим маржинального портфеля UTA, возвращает `""`                                               |
