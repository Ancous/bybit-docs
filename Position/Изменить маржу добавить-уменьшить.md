...
| [positionIdx](</16.Определения значений в запросах и ответах.md#positionIdx>) | нет           | integer | ***Индекс позиции.***<br><br>- Используется для идентификации позиций в различных режимах позиции<br>- Для режима хеджирования этот параметр обязателен<br>- `0`: односторонний режим<br>- `1`: режим хеджирования на стороне покупки<br>- `2`: режим хеджирования на стороне продажи | -            |
...
| [positionIdx](</16.Определения значений в запросах и ответах.md#positionIdx>)       | integer | ***Индекс позиции.***<br><br>- Используется для идентификации позиций в различных режимах позиции.<br>- `0`: односторонний режим<br>- `1`: режим хеджирования на стороне покупки<br>- `2`: режим хеджирования на стороне продажи |
