...
|--------------------------------------------------------------------------|---------------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| [category](</16.Определения значений в запросах и ответах.md#category>)  | нет           | string | ***Тип продукта.***<br><br>- [UTA2.0](</13.Различные режимы аккаунтов.md#единый-торговый-аккаунт-2.0>), [UTA1.0](</13.Различные режимы аккаунтов.md#единый-торговый-аккаунт-1.0>): `linear`, `spot`, `option` | -            |
| [symbol](</16.Определения значений в запросах и ответах.md#symbol>)      | нет           | string | ***Имя символа.***<br><br>- Только заглавными буквами                                                                                                                                                         | -            |
| startTime                                                                | нет           | number | ***Время начала создания ордера.***<br><br>- Интервал составляет 7 дней                                                                                                                                       | -            |
| endTime                                                                  | нет           | number | ***Время окончания создания ордера.***<br><br>- Интервал составляет 7 дней                                                                                                                                    | -            |
| status                                                                   | нет           | string | ***Статус ордера.***<br><br>- `Processing`<br>- `Filled`<br>- `Rejected`                                                                                                                                      | -            |
...
| blockTradeId                                                            | string  | ***Идентификатор блочной сделки.***                                                                                                                                             |
| [category](</16.Определения значений в запросах и ответах.md#category>) | string  | ***Тип продукта.***<br><br>- `linear`, `spot`, `option`                                                                                                                         |
...
| execFee                                                                 | string  | ***Комиссия за исполнение блочной сделки.***                                                                                                                                    |
| status                                                                  | string  | ***Статус ордера.***<br><br>- `Processing`<br>- `Rejected`<br>- `Filled`                                                                                                        |
| execId                                                                  | string  | ***Идентификатор исполнения сделки.***                                                                                                                                          |
| resultCode                                                              | string  | ***Код результата ордера.***<br><br>- `0`: успех                                                                                                                                |
| resultMessage                                                           | string  | ***Сообщение об ошибке.***<br><br>- `""` при `resultCode` = `0`                                                                                                                 |
...
| rejectParty                                                             | string  | ***Причина отмены.***<br><br>- `""` означает `status` = `Filled`<br>- `Taker`, `Maker`, если `status`=`Rejected`.<br>- `bybit` означает, что произошла ошибка на стороне Bybit. |
