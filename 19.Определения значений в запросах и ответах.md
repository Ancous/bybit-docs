...
- `none` независимо классический аккаунт или аккаунт UTA, эта торговая пара не поддерживает маржинальную торговлю
- `both` независимо классический аккаунт или аккаунт UTA, эта торговая пара поддерживает маржинальную торговлю.
- `utaOnly` только для аккаунта UTA эта торговая пара поддерживает маржинальную торговлю.
...
- `eb_convert_uta` аккаунт UTA
- `eb_convert_funding` Аккаунт финансирования
