...
- `none` Независимо от обычного счета или счета UTA, эта торговая пара не поддерживает копи-трейдинг
- `both` Для обоих типов счетов (обычного и UTA), эта торговая пара поддерживает копи-трейдинг
- `utaOnly` Только для счета UTA эта торговая пара поддерживает копи-трейдинг
- `normalOnly` Только для обычного счета эта торговая пара поддерживает копи-трейдинг
