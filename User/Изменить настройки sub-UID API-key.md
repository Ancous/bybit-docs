...
| ContractTrade | нет          | array   | ***Контрактная торговля.***<br><br>- `["Order","Position"]`                                                                                                                                                                                                                                                                | -            |
| Spot          | нет          | array   | ***Спотовая торговля.***<br><br>- `["SpotTrade"]`                                                                                                                                                                                                                                                                          | -            |
| Wallet        | нет          | array   | ***Кошелёк.***<br><br>- `["AccountTransfer", "SubMemberTransferList"]`<br>- Кастодиальные аккаунты не поддерживаются                                                                                                                                                                                                       | -            |
| Options       | нет          | array   | ***Контракты USDC.***<br><br>- `["OptionsTrade"]`                                                                                                                                                                                                                                                                          | -            |
| Derivatives   | нет          | array   | ***Деривативы.***<br><br>- `["DerivativesTrade"]`                                                                                                                                                                                                                                                                          | -            |
| Exchange      | нет          | array   | ***Конвертация.***<br><br>- `["ExchangeHistory"]`                                                                                                                                                                                                                                                                          | -            |
| Earn          | нет          | array   | ***Продукты Earn.***<br><br>- `["Earn"]`                                                                                                                                                                                                                                                                                   | -            |
