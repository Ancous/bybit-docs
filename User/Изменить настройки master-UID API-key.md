...
| ContractTrade (данные объекта `permissions`)     | нет          | array   | ***Контрактная торговля.***<br><br>- `["Order","Position"]`                                                                                                                                                                                                                                                                | -            |
| Spot (данные объекта `permissions`)              | нет          | array   | ***Спотовая торговля.***<br><br>- `["SpotTrade"]`                                                                                                                                                                                                                                                                          | -            |
| Wallet (данные объекта `permissions`)            | нет          | array   | ***Кошелек.***<br><br>- `["AccountTransfer","SubMemberTransfer"]`                                                                                                                                                                                                                                                          | -            |
| Options (данные объекта `permissions`)           | нет          | array   | ***Контракты USDC.***<br><br>- `["OptionsTrade"]`                                                                                                                                                                                                                                                                          | -            |
| Exchange (данные объекта `permissions`)          | нет          | array   | ***Конвертация.***<br><br>- `["ExchangeHistory"]`                                                                                                                                                                                                                                                                          | -            |
| Earn (данные объекта `permissions`)              | нет          | array   | ***Продукты Earn.***<br><br>- `["Earn"]`                                                                                                                                                                                                                                                                                   | -            |
| FiatP2P (данные объекта `permissions`)           | нет          | array   | ***P2P.***<br><br>- `FiatP2POrder`<br>- `Advertising`                                                                                                                                                                                                                                                                      | -            |
| FiatBybitPay (данные объекта `permissions`)      | нет          | array   | ***Bybit Pay.***<br><br>- `FaitPayOrder`                                                                                                                                                                                                                                                                                   | -            |
| FiatConvertBroker (данные объекта `permissions`) | нет          | array   | ***Фиатный конверт-брокер.***<br><br>- `FiatConvertBrokerOrder`                                                                                                                                                                                                                                                            | -            |
