...
| FiatP2P (данные объекта `permissions`)           | нет          | array   | ***P2P.***<br><br>- [`FiatP2POrder`]<br>- [`Advertising`]<br>- На русском отвечает за настройку `Торговля в фиате - P2P - Ордера  ("FiatP2POrder") или Обьявления ("Advertising")`                                                                                                                                         | -            |
| FiatBitPay (данные объекта `permissions`)        | нет          | array   | ***Bybit Pay.***<br><br>- ["FaitPayOrder"]                                                                                                                                                                                                                                                                                 | -            |
| FiatConvertBroker (данные объекта `permissions`) | нет          | array   | ***Фиатный конверт-брокер.***<br><br>- [`FiatConvertBrokerOrder`]<br>- На русском отвечает за настройку `Торговля в фиате - Крипто-фиатный обмен (только брокерам) - Ордера`                                                                                                                                               | -            |
| BitCard (данные объекта `permissions`)           | нет          | array   | ***Использование карты Bybit.***<br><br>- [`BitCard`]                                                                                                                                                                                                                                                                      | -            |
| ByXPost (данные объекта `permissions`)           | нет          | array   | ***Публикацию в сообществе.***<br><br>- [`ByXPost`]                                                                                                                                                                                                                                                                        | -            |
