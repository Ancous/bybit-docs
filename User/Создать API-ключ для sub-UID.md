...
Запрос на создание нового API-ключа для недавно созданного sub-UID.

> Информация:
>
> Используется только API-ключ master-UID.
<!-- -->
> Важное замечание:
>
...
| CopyTrading (данные объекта `permissions`)   | нет           | array   | ***Copy Trading.***<br>**Устаревший параметр.** теперь используется [Как начать Copy Trading](</16.Как начать Copy Trading.md>)<br><br>- Пример и допустимые значения: [`"CopyTrading"`]                                                                                                              | -            |
