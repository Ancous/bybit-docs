...
> Информация:
>
> - Поддерживает все виды исполнений `perpetual`, `futures`, `Spot` и `option`.
...
| [category](</16.Определения значений в запросах и ответах.md#category>) | string  | ***Тип продукта.***<br><br>- `spot`<br>- `option`<br>- `linear`<br>- `inverse`                                                                                                                                                                                                                                                             |
