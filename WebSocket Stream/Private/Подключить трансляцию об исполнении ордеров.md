...
| [category](</16.Определения значений в запросах и ответах.md#category>)           | string  | ***Тип продукта.***<br><br>- `spot`<br>- `linear`<br>- `inverse`<br>- `option`                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| [createType](</16.Определения значений в запросах и ответах.md#createType>)       | string  | ***Тип создания ордера.***<br><br>- <br><br>- У `spot` отсутствует этот параметр                                                                                                                                                                                                                                                                                                                                                                                                |
