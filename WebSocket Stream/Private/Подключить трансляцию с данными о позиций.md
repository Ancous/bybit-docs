...
| side                                                                                    | string  | ***Сторона позиции.***<br><br>- `Buy`, `Sell`<br>- Пустая позиция возвращает `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| size                                                                                    | string  | ***Размер позиции.***                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [positionIdx](</16.Определения значений в запросах и ответах.md#positionIdx>)           | integer | ***Используется для идентификации позиций в разных режимах позиций.***                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| autoAddMargin                                                                           | integer | ***Будет ли добавляться маржа автоматически.***<br><br>- `0`: false, `1`: true<br>- Для аккаунта UTA значимо только когда аккаунт UTA включает `ISOLATED_MARGIN`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| positionIM                                                                              | string  | ***Начальная маржа.***<br><br>- То же значение, что и у `positionIMByMp`<br>- Обратите внимание на [новый расчет маржи: корректировки и последствия](https://www.bybit.com/en/help-center/article/Understanding-the-Adjustment-and-Impact-of-the-New-Margin-Calculation)<br>- Режим портфельной маржи возвращает `""`                                                                                                                                                                                                                                                                                                                                                                               |
| positionIMByMp                                                                          | string  | ***Начальная маржа, рассчитанная по Mark Price.***<br><br>- То же значение, что и для `positionIM`<br>- Режим портфельной маржи возвращает `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| positionMM                                                                              | string  | ***Маржа поддержки.***<br><br>- То же значение, что и для `positionMMByMp`<br>- Режим портфельной маржи возвращает `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| positionMMByMp                                                                          | string  | ***Маржа поддержки, рассчитанная по Mark Price***<br<br>- То же значение, что и для `positionMM`<br>- Режим портфельной маржи возвращает `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| liqPrice                                                                                | string  | ***Цена ликвидации позиции.***<br><br>- Изолированная маржа: это реальная цена для изолированных и кросс-позиций, поле остаеться `""` когда `liqPrice` <= `minPrice` или `liqPrice` >= `maxPrice`<br>- Кросс-маржа: это оценочная цена для кросс-позиций (потому что единый режим контролирует уровень риска по аккаунту), поле остаеться `""` когда `liqPrice` <= `minPrice` или `liqPrice` >= `maxPrice`<br>- Портфельной маржа: это поле `""` и цена ликвидации не будет предоставлена                                                                                                                                                                                                           |
...
| sessionAvgPrice                                                                         | string  | ***Средняя цена сессии контракта USDC.***<br><br>- Та же цифра, что и средняя цена входа, показанная в веб-интерфейсе                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| delta                                                                                   | string  | ***Дельта.***<br><br>- Передается только при подписке на позицию опциона                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| gamma                                                                                   | string  | ***Гамма.***<br><br>- Передается только при подписке на позицию опциона                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| vega                                                                                    | string  | ***Вега.***<br><br>- Передается только при подписке на позицию опциона                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| theta                                                                                   | string  | ***Тета.***<br><br>- Передается только при подписке на позицию опциона                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| openTime                                                                                | string  | ***Временная метка открытия позиции (в миллисекундах).***                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| seq                                                                                     | long    | ***Кросс-последовательность.***<br><br>- Используется для ассоциации каждого fill и каждого обновления позиции<br>- Разные символы могут иметь одинаковый `seq`, пожалуйста, используйте `seq` + `symbol` для проверки уникальности<br>- Возвращает `"-1"`, если символ никогда не торговался<br>- Возвращает `seq`, обновленный последней транзакцией, когда есть настройки типа плеча, лимит риска                                                                                                                                                                                                                                                                                                |
| tpslMode                                                                                | string  | **Устаревшее поле.**<br><br>- всегда `Full`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| bustPrice                                                                               | string  | **Устаревшее поле.**<br><br>- всегда `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| positionBalance                                                                         | string  | **Устаревшее поле.**<br><br>- Можно ссылаться на поле `positionIM` или `positionIMByMp`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| tradeMode                                                                               | integer | **Устаревшее поле.**<br><br>- всегда `0`<br>- Проверьте раздел [Получить информацию об учетной записи](</Account/Получить информацию об аккаунте.md>), чтобы узнать режим маржи.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
