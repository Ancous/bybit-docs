...
|feeCurrency | string | **Устарело**. Валюта торговой комиссии только для Spot. Пожалуйста, ознакомьтесь с валютой комиссии за спотовую торговлю [здесь](</19.Определения значений в запросах и ответах.md#spotFeeCurrencyInstruction>) |
