...
| cumExecFee                                                                        | string  | ***Накопленная исполненная торговая комиссия.***<br><br>- `inverse`, `option`: отображает накопленную комиссию<br>- `linear`, `spot`: **Устарело**. Используйте `cumFeeDetail`<br>- После обновления до единого аккаунта (UTA), вы можете использовать `execFee`  для каждой отдельной сделки в потоке исполнений [Подключить трансляцию об исполнении ордеров](<Подключить трансляцию об исполнении ордеров.md>)                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| marketUnit                                                                        | string  | ***Единица `qty` при создании `spot` market orders для единого аккаунта.***<br><br>- `baseCoin`, `quoteCoin`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
