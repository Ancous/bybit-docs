...
|cts       |number    |Временная метка, полученная от системы сопоставления данных, когда были получены данные этой книги ордеров. Её можно сопоставить с `T` из [публичного торгового канала](#).                                             |
