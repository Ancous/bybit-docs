...
>
>**Депозит в блокчейне:** Если количество подтверждений в блокчейне не достигло уровня, установленного для контроля рисков,
> часть средств будет заморожена на определенный период до их разблокировки.  
>**Покупка криптовалюты:** При возникновении риска средства будут заморожены на определенный срок и не смогут быть выведены.
