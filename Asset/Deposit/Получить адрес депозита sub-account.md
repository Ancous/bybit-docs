...
Запрос информации об адресе депозита для sub-account.

>Информация:
>
>- Используйте только API-ключ главного UID
>- Депозитный адрес кастодиального sub-account получить невозможно
...
|subMemberId       |да   |string |Идентификатор sub-account      |-  |
