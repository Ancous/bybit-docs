...
[типами аккаунтов](</16.Определения значений в запросах и ответах.md#accountType>) с одним и тем же UID.
...
| [status](</16.Определения значений в запросах и ответах.md#transferStatus>) | нет           | string     | ***Статус перевода.***                                                                                                                         | -            |
...
| [fromAccountType](</16.Определения значений в запросах и ответах.md#accountType>) | string | ***Тип учетной записи откуда произведен перевод.***                                                  |
| [toAccountType](</16.Определения значений в запросах и ответах.md#accountType>)   | string | ***Тип учетной записи куда произведен перевод.***                                                    |
| timestamp                                                                         | string | ***Временная метка создания передачи (в миллисекундах).***                                           |
| [status](</16.Определения значений в запросах и ответах.md#transferStatus>)       | string | ***Статус перевода.***                                                                               |
