...
>
> Вы можете использовать эту [конечную точку](</Account/Получить информацию DCP.md>) для получения текущей
> конфигурации DCP.
>
...
> На основе механизма частного подключения через WebSocket и heartbeat, Bybit предоставляет функцию защиты от
> отключения.\
...
|-------------|---------------|---------|------------------------------------------------------------------------------------|--------------|
| timeWindow  | да            | integer | ***Время окна отключения.***<br><br>- Единица измерения: секунда<br>- [`3`, `300`] | -            |
| product     | нет           | string  | - `OPTIONS`<br>- `DERIVATIVES`<br>- `SPOT`                                         | `OPTIONS`    |
