...
|markPrice  |string      |Mark Price символа на момент исполнения.<br>Классический аккаунт `spot` не поддерживается.              |
|indexPrice  |string      |Index Price символа на момент исполнения.<br>Действительно для `option`.                                            |
