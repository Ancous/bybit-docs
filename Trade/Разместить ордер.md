...
|[timeInForce](#)    	                  |нет	 |string   	  |***[Время действия ордера](https://www.bybit.com/en/help-center/article/What-Are-Time-In-Force-TIF-GTC-IOC-FOK)***<br><br>Маркет-ордер всегда использует IOC  |`GTC`   |
...
|[tpTriggerBy](#)    	                  |нет	 |string   	  |***Тип цены, при котором активируется тейк-профит.***<br><br>Действительно для `linear` и `inverse` контрактов.<br><br>- `MarkPrice`<br>- `IndexPrice`<br>- `LastPrice`       |`LastPrice`   |
|[slTriggerBy](#)    	                  |нет	 |string   	  |***Тип цены, при котором активируется стоп-лосс.***<br><br>Действительно для `linear` и `inverse` контрактов.<br><br>- `MarkPrice`<br>- `IndexPrice`<br>- `LastPrice`                       |`LastPrice`   |
...
|[smpType](#)   	                  |нет	 |string   	  |***Тип исполнения [SMP](<../SMP.md>).***      |-   |
