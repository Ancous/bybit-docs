...
|mmp  	                  |нет	 |boolean   	  |***Защита маркет-мейкера ([MMP](</Account/Установить MMP.md>)).***<br><br>Действительно для `option` контрактов.<br><br>- Значение true означает установку ордера в качестве ордера защиты<br>&nbsp;&nbsp;маркет-мейкера.               |-   |
