...
|---------------------------------------------------------------------------------------------------|---------------|--------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| [category](</16.Определения значений в запросах и ответах.md#category>)                           | да            | string | ***Тип продукта.***<br><br>- [UTA2.0](</13.Различные режимы аккаунтов.md#единый-торговый-аккаунт-2.0>): `option`, `spot`, `linear`, `inverse`<br>- [UTA1.0](</13.Различные режимы аккаунтов.md#единый-торговый-аккаунт-1.0>): `spot`, `linear`, `option` | -            |
| request                                                                                           | да            | array  | ***Объект.***                                                                                                                                                                                                                                            | -            |
| [symbol](</16.Определения значений в запросах и ответах.md#symbol>) (объект объекта `request`)    | да            | string | ***Имя символа.***<br><br>- Только заглавными буквами                                                                                                                                                                                                    | -            |
| orderId (объект объекта `request`)                                                                | нет           | string | ***Идентификатор ордера.***<br><br>- Требуется либо `orderId`, либо `orderLinkId`                                                                                                                                                                        | -            |
| orderLinkId (объект объекта `request`)                                                            | нет           | string | ***Пользовательский идентификатор ордера.***<br><br>- Требуется либо `orderId`, либо `orderLinkId`                                                                                                                                                       | -            |
