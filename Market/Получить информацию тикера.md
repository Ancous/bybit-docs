...
|list                                                                                         |array     |Массив объектов с данными по символам                                                           |
...
|[curPreListingPhase](<../99.Определения значений в запросах и ответах.md#curAuctionPhase>)   |string    |Текущая фаза предварительного-контракта                                                         |
...
|---------------|--------|------------------------------------------------------------|
|category       |string  |Тип продукта                                                |
|list           |array   |Массив объектов с данными по инструментам                   |
