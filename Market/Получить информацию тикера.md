...
|baseCoin  	                                                            |нет	      |string    |Базовая монета, только заглавными буквами. Применимо только для `option`  |По умолчанию|
|expDate  	                                                            |нет	      |string    |Дата истечения опциона, например 25DEC22. Применимо только для `option`   |По умолчанию|
