...
Получить значение открытого интереса (open interest) для каждого торгового символа.
...
|[intervalTime](<../99.Определения значений в запросах и ответах.md#intervalTime>)  	       |да	 |string   	  |Интервал времени агрегации данных        |-    |
