...
|------------------------------------------------------------------------------|---------------|-------------|---------------------------------------------------------|--------------|
| [category](</16.Определения значений в запросах и ответах.md#category>)      | да            | string      | ***Тип продукта.***<br><br>- `option`                   | -            |
| baseCoin                                                                     | нет           | string      | ***Базовая монета.***<br><br>- Только заглавные буквы   | `BTC`        |
| quoteCoin                                                                    | нет           | string      | ***Котируемая монета.***<br><br>- USD или USDT          | `USD`        |
| [period](</16.Определения значений в запросах и ответах.md#optionPeriod>)    | нет           | integer     | ***Период.***                                           | `7`          |
