...
|------------------------------------------------------------------------------|---------------|---------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| [category](</16.Определения значений в запросах и ответах.md#category>)      | да            | string  | ***Тип продукта.***<br><br>- `spot`, `linear`, `inverse`, `option`                                                                                                                                                                                                                                                        | -            |
| [symbol](</16.Определения значений в запросах и ответах.md#symbol>)          | нет           | string  | ***Имя символа.***<br><br>- Только заглавными буквами                                                                                                                                                                                                                                                                     | -            |
| [symbolType](</16.Определения значений в запросах и ответах.md#symbolType>)  | нет           | string  | ***Тип символа.***<br><br>- `linear`, `inverse` и `spot`<>- Регион, к которому принадлежит торговая пара                                                                                                                                                                                                                  | -            |
| [status](</16.Определения значений в запросах и ответах.md#status>)          | нет           | string  | ***Фильтр по статусу символа.***<br><br>- По умолчанию возвращаются только символы со статусом `Trading`<br>- Для `spot` доступны только `Trading`<br>- Для `linear` и `inverse` при status=PreLaunch возвращаются [Pre-Market контракты](https://www.bybit.com/help-center/article/Introduction-to-Pre-Market-Perpetual) | -            |
| baseCoin                                                                     | нет           | string  | ***Базовая монета.***<br><br>- Только заглавные буквы<br>- Применяется для `linear`, `inverse` и `option`<br>- Для `option` по умолчанию возвращается BTC                                                                                                                                                                 | -            |
| limit                                                                        | нет           | integer | ***Ограничение размера данных на странице.***<br><br>- [`1`, `1000`]                                                                                                                                                                                                                                                      | `500`        |
...
| nextPageCursor                                                                        | string  | ***Курсор.***<br><br>- Используйте значение `nextPageCursor` из ответа для получения следующей страницы набора результатов                                                                                                                           |
...
| [copyTrading](</16.Определения значений в запросах и ответах.md#copyTrading>)         | string  | ***Символ копитрейдинга или нет.***                                                                                                                                                                                                                  |
...
| forbidUplWithdrawal                                                                   | boolean | ***Следует ли запретить вывод нереализованной прибыли.***                                                                                                                                                                                            |
...
| symbolId                                                            | integer | ***Идентификатор названия символа.***                                                                |
| symbol                                                              | string  | ***Название символа.***                                                                              |
| optionsType                                                         | string  | ***Тип `option`.***<br><br>- `Call`, `Put`                                                           |
| [status](</16.Определения значений в запросах и ответах.md#status>) | string  | ***Статус инструмента.***                                                                            |
| baseCoin                                                            | string  | ***Базовая монета.***                                                                                |
| quoteCoin                                                           | string  | ***Котируемая монета.***                                                                             |
| settleCoin                                                          | string  | ***Расчетная монета.***                                                                              |
| launchTime                                                          | string  | ***Временная метка запуска (в миллисекундах).***                                                     |
| deliveryTime                                                        | string  | ***Время доставки (в миллисекундах).***                                                              |
| deliveryFeeRate                                                     | string  | ***Плата за экспирацию.***                                                                           |
| priceFilter                                                         | object  | ***Атрибуты цены.***                                                                                 |
| minPrice                                                            | string  | ***Минимальная цена ордера.***                                                                       |
| maxPrice                                                            | string  | ***Максимальная цена ордера.***                                                                      |
...
| [category](</16.Определения значений в запросах и ответах.md#category>)      | да            | string  | ***Тип продукта.***<br><br>- `spot`, `linear`, `inverse`, `option`                                                                                                                                                                                                                                                            | -                  |
| [symbol](</16.Определения значений в запросах и ответах.md#symbol>)          | нет           | string  | ***Имя символа.***<br><br>- Только заглавными буквами                                                                                                                                                                                                                                                                         | -                  |
| [symbolType](</16.Определения значений в запросах и ответах.md#symbolType>)  | нет           | string  | ***Тип символа.***<br><br>- Только для `linear`, `inverse` и `spot`<br>- Регион, к которому принадлежит торговая пара                                                                                                                                                                                                         | -                  |
| [status](</16.Определения значений в запросах и ответах.md#status>)          | нет           | string  | ***Фильтр по статусу символа.***<br><br>- По умолчанию возвращаются только символы со статусом `Trading`<br>- Для `spot` доступны только `Trading`<br>- Для `linear` и `inverse` при `status`=`PreLaunch` возвращаются [Pre-Market контракты](https://www.bybit.com/help-center/article/Introduction-to-Pre-Market-Perpetual) | -                  |
| limit                                                                        | нет           | integer | ***Ограничение размера данных на странице.***<br><br>- [`1`, `1000`]                                                                                                                                                                                                                                                          | `500`              |
| cursor                                                                       | нет           | string  | ***Курсор.***<br><br>- Используйте значение `nextPageCursor` из ответа для получения следующей страницы набора результатов                                                                                                                                                                                                    | -                  |
...
| baseCoin                                                                          | string  | ***Базовая монета.***                                                                                                                                                                                                                                                                                                                                                                                                                       |
| quoteCoin                                                                         | string  | ***Котируемая монета.***                                                                                                                                                                                                                                                                                                                                                                                                                    |
| innovation                                                                        | string  | **Устаревшее поле.** Пожалуйста смотрите `symbolType`                                                                                                                                                                                                                                                                                                                                                                                       |
| [symbolType](</16.Определения значений в запросах и ответах.md#symbolType>)       | string  | ***Регион, к которому принадлежит торговая пара.***                                                                                                                                                                                                                                                                                                                                                                                         |
...
| stTag                                                                             | string  | ***Имеет ли токен [специальную метку обработки](https://www.bybit.com/en/help-center/article/Bybit-Special-Treatment-ST-Label-Management-Rules).***<br><br>- `0`: false<br>- `1`: true                                                                                                                                                                                                                                                      |
| lotSizeFilter                                                                     | object  | ***Атрибуты размера.***                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| priceFilter                                                                       | object  | ***Атрибуты цены.***                                                                                                                                                                                                                                                                                                                                                                                                                        |
| tickSize                                                                          | string  | ***Шаг для увеличения/уменьшения цены ордера.***                                                                                                                                                                                                                                                                                                                                                                                            |
| riskParameters                                                                    | object  | ***Параметры риска для цены лимитного ордера.***<br><br>- см. [объявление](https://announcements.bybit.com/en/article/title-adjustments-to-bybit-s-spot-trading-limit-order-mechanism-blt786c0c5abf865983/)                                                                                                                                                                                                                                 |
| priceLimitRatioX                                                                  | string  | ***Коэффициент X.***                                                                                                                                                                                                                                                                                                                                                                                                                        |
| priceLimitRatioY                                                                  | string  | ***Коэффициент Y.***                                                                                                                                                                                                                                                                                                                                                                                                                        |
