...
>Охватывает:
>
>Спот / Контракты USDT / Контракты USDC / Обратные контракты / Опционы
...
Запрашивает спецификации инструментов активных торговых пар.
...
|---------------------------------------------------------------------|--------------|----------|---------------------------------------------------------------------------------------------------------|------------|
|[category](<99.Определения значений в запросах и ответах#category>)  |да          |string    |Тип продукта                                                                                             |linear      |
|[symbol](<99.Определения значений в запросах и ответах#symbol>)	  |нет         |string    |Имя символа                                                                                              |-           |
|[status](<99.Определения значений в запросах и ответах#status>)      |нет         |string    |Интервал свечей                                                                                          |-           |
|baseCoin	      	         	      	         	                  |нет      	 |string    |Временная метка начала (мс)                                                                              |-           |
|limit         		         	      	                              |нет      	 |integer   |Лимит на размер данных на страницу. [1, 1000]                                                            |500         |
|cursor	    	         	         		                          |нет      	 |string    |Курсор. Используйте токен nextPageCursor из ответа для получения следующей страницы набора результатов   |-           |
...
|[contractType](<99.Определения значений в запросах и ответах#contractType>)        |string    |Тип контракта                                                                                                        |
|[status](<99.Определения значений в запросах и ответах#status>)                    |string    |Статус инструмента                                                                                                   |
...
|[copyTrading](<99.Определения значений в запросах и ответах#copyTrading>)          |string    |Символ копитрейдинга или нет                                                                                         |
...
|[curAuctionPhase](<99.Определения значений в запросах и ответах#curAuctionPhase>)  |string    |Текущая фаза аукциона                                                                                                |
|phases                                                                             |array     |Информация о времени каждой фазы                                                                                     |
|[phase](<99.Определения значений в запросах и ответах#curAuctionPhase>)            |string    |Фаза предварительной торговли                                                                                        |
...
|Параметр  	         	         	                	              |Обязательный	 |Тип   	|Комментарии                                                                                              |По умолчанию|
|---------------------------------------------------------------------|--------------|----------|---------------------------------------------------------------------------------------------------------|------------|
|[category](<99.Определения значений в запросах и ответах#category>)  |true          |string    |Тип продукта                                                                                             |linear      |
|[symbol](<99.Определения значений в запросах и ответах#symbol>)	  |false         |string    |Имя символа                                                                                              |-           |
|[status](<99.Определения значений в запросах и ответах#status>)      |false         |string    |Интервал свечей                                                                                          |-           |
|baseCoin	      	         	      	         	                  |false      	 |string    |Временная метка начала (мс)                                                                              |-           |
|limit         		         	      	                              |false      	 |integer   |Лимит на размер данных на страницу. [1, 1000]                                                            |500         |
|cursor	    	         	         		                          |false      	 |string    |Курсор. Используйте токен nextPageCursor из ответа для получения следующей страницы набора результатов   |-           |
