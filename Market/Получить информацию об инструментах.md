...
|stTag    |string    |Имеет ли [специальную метку](https://www.bybit.com/en/help-center/article/Bybit-Special-Treatment-ST-Label-Management-Rules) обработки. `0`: false, `1`: true       |
|lotSizeFilter   |object    |Атрибуты размера                                                                                           |
