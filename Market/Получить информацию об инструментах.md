...
|[symbolType](<../19.Определения значений в запросах и ответах#symbolType>)	  |нет           |string    |Тип символа: регион, к которому принадлежит торговая пара, только для `linear`, `inverse` и `spot`                            |-           |
