...
|------------------------------------------------------------------------|---------------|--------|------------------------------------------------------------|--------------|
| productType                                                            | да            | string | ***Тип продукта.***<br><br>- Передается только `contract`. | -            |
| [groupId](</16.Определения значений в запросах и ответах.md#groupId>)  | нет           | string | ***Идентификатор группы.***                                | -            |
...
| feeRates        | object  | ***Подробная информация о ставках комиссий для различных категорий.***<br><br>- `pro`, `marketMaker` |
| pro             | array   | ***Структуры комиссий pro.***                                                                        |
| level           | string  | ***Уровень Pro.***<br><br>- `Pro 1`, `Pro 2`, `Pro 3`, `Pro 4`, `Pro 5`, `Pro 6`                     |
...
| level           | string  | ***Уровень Market Maker.***<br><br>- `MM 1`, `MM 2`, `MM 3`                                          |
| takerFeeRate    | string  | ***Ставка комиссии тейкера.***                                                                       |
| makerFeeRate    | string  | ***Ставка комиссии мейкера.***                                                                       |
| makerRebate     | string  | ***Ставка комиссии мейкера по возврату средств.***                                                   |
