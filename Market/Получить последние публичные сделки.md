...
|mP  |string       |Mark price, уникальное поле для опционов                                             |
|iP  |string       |Index price, уникальное поле для опционов                                             |
|mIv  |string       |Mark IV (маркет implied volatility), уникальное поле для опционов                                             |
|iv  |string       |Implied volatility (оценочная волатильность), уникальное поле для опционов                                             |
