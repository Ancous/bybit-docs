...
| coin             | да            | string | ***Базовая монета.***<br><br>- Только заглавными буквами<br>- Вы можете получить залоговую монету [Получить информацию об обеспечении](<Получить информацию об обеспечении.md>)<br>- USDT, USDC установить нельзя   | -            |
