...
Пакетный запрос на установку залоговой монеты
...
|coin                     |да  |string     |***Базовая монета.***<br><br>Только заглавными буквами<br><br>- Вы можете получить залоговую монету [здесь](#)<br>- USDT, USDC установить нельзя       |-   |
