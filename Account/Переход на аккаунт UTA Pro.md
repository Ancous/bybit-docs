...
>
> - Если `unifiedMarginStatus`=`5` - это аккаунт UTA. Вы можете вызвать конечную точку ниже для обновления до
>   аккаунт UTA Pro. Через некоторое время проверьте
>   [Получить информацию об аккаунте](<Получить информацию об аккаунте.md>), и если `unifiedMarginStatus`=`6`, то
>   аккаунт успешно обновлен до UTA Pro.
<!-- -->
> Требования к уровню аккаунта:
>
> - Для master-аккаунта: обновление разрешено, если пользователь имеет уровень VIP или PRO.
> - Для sub-аккаунта: обновление разрешено, только если master-аккаунт имеет уровень VIP или PRO.
<!-- -->
> Информация:
>
...
>
> - При обновлении с UTA до UTA Pro: убедитесь, что нет открытых ордеров
>
