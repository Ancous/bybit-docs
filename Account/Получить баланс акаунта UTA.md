...
|-------------------------------------------------------------------------------|---------------|--------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| [accountType](</16.Определения значений в запросах и ответах.md#accountType>) | да            | string | ***Тип аккаунта.***<br><br>- Чтобы получить баланс аккаунта финансирования, пожалуйста, перейдите к этой [конечной точке](</Asset/Balances/Получить баланс аккаунта финансирования.md>)                                                    | -            |
