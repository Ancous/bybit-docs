...
|------------|--------|----------------------------------------------------------------------------------------------------------------------------------------------|
| dcpInfos   | array  | ***Список объектов***                                                                                                                        |
| product    | string | ***Продукт.***<br><br>- `SPOT`, `DERIVATIVES`, `OPTIONS`                                                                                     |
| dcpStatus  | string | ***Статус DCP.***<br><br>- [Установить DCP](</Trade/Установить DCP.md>) статус: `ON`.                                                        |
| timeWindow | string | ***Временной интервал срабатывания DCP.***<br><br>- Задаётся пользователем<br>- Диапазон [`3`, `300`] секунд<br>- По умолчанию: `10` секунд. |
