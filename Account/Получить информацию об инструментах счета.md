...
|maxOrderQty   |string      |**Устарело.** Максимальное количество для ордеров, см. `maxLimitOrderQty`, `maxMarketOrderQty` в зависимости от типа заказа            |
|minOrderAmt   |string      |Минимальная сумма для ордеров                                             |
|maxOrderAmt   |string      |**Устарело.** Максимальная сумма заказа, вместо этого проверяются `maxLimitOrderQty` и `maxMarketOrderQty`                     |
